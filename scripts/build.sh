#!/bin/bash
# Generated by dsh-super-injector dev_scaffold_plugin (build for llm-degen-heal):
# links the harness packages this plugin type-checks against, then compiles
# src/ → lib/ with the checkout's tsc. DSH_CHECKOUT auto-probe below.
set -euo pipefail
